# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-12-04 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.CharField(choices=[('CREATED', 'Order created'), ('SENT TO KITCHEN', 'Order sent to kitchen'), ('STARTED', 'Order started'), ('READY', 'Order ready to be served'), ('SERVED', 'Order served'), ('COMPLETED', 'Order completed')], default='CREATED', max_length=15)),
